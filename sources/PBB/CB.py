...
def start_client():
    ...
    message = f'{client_name},{hex_dig},Cancel_B'
    print(f" {client_name} sent: Cancel_B to PBB")
    ...
    try:
        while True:
            ...
            break
            #else:
             #   print(f"The PBB responded with: {response}_B. The exchange has been aborted")
             #   break
