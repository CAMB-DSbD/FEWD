...
def start_client():
    ...
    message = f'{client_name},{hex_dig},Cancel_A'  # or 'negative' for client_2.py
    print(f" {client_name} sent: Cancel_A to PBB")
    ...
    try:
        while True:
            ...
            #else:
            #    print(f"The PBB responded with: {response}_A. The exchange has been aborted")
            #    break
