 ...
 * 
 *  This version includes a LTL formula (last lines)
 *  that I use to force spin to generate the sequences of 
 *  messages that lead from the init to the cancel state.
 * 
 ...
 */
 ...
 07) carlos@fewd% pan -a -e -c5000 to generate 5000 trail files max
    The model will output 
    ali_bob_smartPBB.pml1.trail
    ali_bob_smartPBB.pml2.trail
    ali_bob_smartPBB.pml3.trail
    etc.
    ali_bob_smartPBB.pml5000.trail
