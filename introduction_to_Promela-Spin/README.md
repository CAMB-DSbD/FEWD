# Hello-world examples of Promela models 

These examples that might help beginners
to write and run their first Promela 
models.

## Promela and Spin  
Promela is the language for encoding the model
and Spin is the model-checker.
